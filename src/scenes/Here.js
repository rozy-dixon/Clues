class Here extends Phaser.Scene {
    constructor() {
        super('hereScene')
    }
    ...
    create() {
        // plan: finding the first E spawns a new E
        // chunk taken out, the question is there
        // static when you get close to the glitch
        // die when you hit the black
        // take the player down to the first E, back 
        // up and far from the black to the second, 
        // then into the final part

        console.log('%cHERE SCENE :^)', "color: #cfd1af")   // making sure
